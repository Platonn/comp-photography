...
# stata-1 -> stata-2
stata1 = cv2.imread(LabFiles.input(3, 3, 'stata-1'))
stata2 = cv2.imread(LabFiles.input(3, 3, 'stata-2'))
...
result = homography.applyInterpolated(stata2, stata1)

cv2.imwrite(LabFiles.output(3, 3, 'homographied-stata-2-1'), result)
...
# show
LabFiles.show(3, 3, 'homographied-stata-2-1')