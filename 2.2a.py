...
# read file
imSec3_1 = cv2.imread(LabFiles.input(2, 2, 'sec3-1'), cv2.IMREAD_ANYCOLOR | cv2.IMREAD_ANYDEPTH)
imSec3_1_exposure = LabFiles.exposureTime(2, 2, 'sec3-1')

imSec3_2 = cv2.imread(LabFiles.input(2, 2, 'sec3-2'), cv2.IMREAD_ANYCOLOR | cv2.IMREAD_ANYDEPTH)
imSec3_2_exposure = LabFiles.exposureTime(2, 2, 'sec3-2')

imSec3_3 = cv2.imread(LabFiles.input(2, 2, 'sec3-3'), cv2.IMREAD_ANYCOLOR | cv2.IMREAD_ANYDEPTH)
...
print result
resultToneMapped = BilateralFilterToneMapper.run(result, -1, 0.3, 8)
