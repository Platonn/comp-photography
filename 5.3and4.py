...
def readKnight():
	...
	def getFileName(number):
		result = LabFiles.input(5, 3, 'knight-prefix') + withLeadingZeros(number) + '.resized.resized.png'
		# print result
		return result
...
Relighter.relightVideo(LabFiles.output(5, 4, 'knight-grace-video', '.avi'), 10, 4, images, dirs, intens, graceProbe)

# LabFiles.show(5, 3, 'knight-grace')
LabFiles.show(5, 4, 'knight-grace-video', '.avi')